...
task='DM'
nTR_=750
roi_short='LH_DefaultB_PFCv_2'
grey = 211/256
HMMtask = dd.io.load(HMMdir+roi_short+'.h5','/'+task)
...
fig.tight_layout()
fig.savefig(figurepath+'HMM/tune_ll_Yeo'+figdirend+task+'_'+roi_short+'.png', bbox_extra_artists=(lgd,), bbox_inches='tight')
